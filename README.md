...
* **Signalisation :** LED Rouge / État Fermé (Pin 11), LED Verte / État Ouvert (Pin 12), Buzzer (Pin 13)
* **Configuration par Défaut :** Code PIN initial : 0707, Délai de fermeture automatique : 5000 ms
